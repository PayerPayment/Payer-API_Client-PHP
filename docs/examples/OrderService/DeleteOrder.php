<?php
  ...
  use Payer\Api\OrderService\DeleteOrderRequest;
  ...
  try {
    ...
    $deleteOrderRequest = new DeleteOrderRequest($env['wsdl_location']['order_service'], $env['options']);
    $deleteOrderResponse = $deleteOrderRequest->create([
      'session' => $createSessionResponse,
      'request' => [
