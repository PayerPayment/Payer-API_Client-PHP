<?php
  ...
  use Payer\Api\InformationService\GetPaymentTransactionsRequest;
  ...
  try {
    ...
    $getPaymentTransactionsRequest = new GetPaymentTransactionsRequest($env['wsdl_location']['information_service'], $env['options']);
    $getPaymentTransactionsResponse = $getPaymentTransactionsRequest->create([
      'session' => $createSessionResponse,
      'request' => [
    ...
    var_dump($getPaymentTransactionsResponse);
