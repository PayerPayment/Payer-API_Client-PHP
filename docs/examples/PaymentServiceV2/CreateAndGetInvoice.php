...
use Payer\Api\PaymentServiceV2\CreateInvoiceRequest;
use Payer\Api\PaymentServiceV2\GetInvoiceRequest;
...
$env = include(dirname(__FILE__) . "/../../../config/env.php");
  ...
  try {
    ...
    $getInvoiceResponse = $getInvoiceRequest->create([
      'session' => $createSessionResponse,
      'request' => [
        'invoiceNumber' => $createInvoiceResponse->invoice->invoiceNumber
      ]
    ]);
