<?php
  ...
  use Payer\Api\OrderService\DenyOrderRequest;
  ...
  try {
    ...
    $denyOrderRequest = new DenyOrderRequest($env['wsdl_location']['order_service'], $env['options']);
    $denyOrderResponse = $denyOrderRequest->create([
      'session' => $createSessionResponse,
      'request' => [
