<?php
  ...
  use Payer\Api\InformationService\GetSaleTransactionsRequest;
  ...
  try {
    ...
    $getSaleTransactionsRequest = new GetSaleTransactionsRequest($env['wsdl_location']['information_service'], $env['options']);
    $getSaleTransactionsResponse = $getSaleTransactionsRequest->create([
      'session' => $createSessionResponse,
      'request' => [
    ...
    var_dump($getSaleTransactionsResponse);
